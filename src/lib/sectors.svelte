<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
    <div>
      <p class="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-green-400">
        Brand new
      </p>
    </div>
  ...
  <div class="grid gap-5 row-gap-5 mb-8 lg:grid-cols-4 sm:grid-cols-2">
    <a href="/" aria-label="View Item" class="inline-block overflow-hidden duration-300 transform bg-green-400 rounded shadow-sm hover:-translate-y-2">
    ...
    <a href="/" aria-label="View Item" class="inline-block overflow-hidden duration-300 transform bg-yellow-400 rounded shadow-sm hover:-translate-y-2">
      <div class="flex flex-col h-full">
    ...
    <a href="/" aria-label="View Item" class="inline-block overflow-hidden duration-300 transform bg-blue-400 rounded shadow-sm hover:-translate-y-2">
      <div class="flex flex-col h-full">
    ...
    <a href="/" aria-label="View Item" class="inline-block overflow-hidden duration-300 transform bg-red-400 rounded shadow-sm hover:-translate-y-2">
      <div class="flex flex-col h-full">
